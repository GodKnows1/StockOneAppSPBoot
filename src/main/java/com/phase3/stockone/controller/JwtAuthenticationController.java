...
public class JwtAuthenticationController {
	...
	@Autowired
	private UsersAppRepository userrepo;
	
	@RequestMapping(value = "/register", method = RequestMethod.POST)
	public ResponseEntity<?> saveUser(@RequestBody UsersApp user) throws Exception {
...
//if not using dto ,then for register name and not user name
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
		...
		return ResponseEntity.ok(new JwtResponse(token,datApp));
	}
